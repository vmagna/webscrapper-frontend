...
export class HistoricosComponent implements OnInit {
  ...
  private static OBJETOSEARCH = 'searchComponentHistorico';
   ...
   */
  get objetosearch() {
    return sessionStorage.getItem(HistoricosComponent.OBJETOSEARCH);
  }
  set objetosearch(objBusca: any) {
    sessionStorage.setItem(HistoricosComponent.OBJETOSEARCH, JSON.stringify(objBusca));
  }
